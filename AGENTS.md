...
Guia para agentes de IA (Codex, Cursor, Cline, Copilot, Aider, etc.) ao trabalhar neste repositório.

> Este arquivo é o **espelho** de [CLAUDE.md](CLAUDE.md). Mantenha-os sincronizados.
...
Este projeto adota guidelines baseadas em skills (ver [.agents/skills](.agents/skills)):
...
As regras por área estão em [.agents/rules/](.agents/rules/).
